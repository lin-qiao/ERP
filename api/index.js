...
export const purchaseDetail = (data) =>
  request("GET", "/api/purchaseDetail", data);
export const purchaseBackout = (data) =>
  request("POST", "/api/purchaseBackout", data);
...
export const purchaseStatList = (data) =>
  request("GET", "/api/purchaseStatList", data);
export const purchaseCount = (data) =>
  request("GET", "/api/purchaseCount", data);
export const userInfo = (data) => request("GET", "/api/userInfo", data);
export const supplierList = (data) => request("GET", "/api/supplierList", data);

// 商品销售列表
export const goodsSaleStatList = (data) =>
  request("GET", "/api/goodsSaleStatList", data);
//品牌销售列表
export const brandSaleStatList = (data) =>
  request("GET", "/api/brandSaleStatList", data);
...
export const businessFlowList = (data) =>
  request("GET", "/api/businessFlowList", data);

export const storageList = (data) => request("GET", "/api/storageList", data);
export const storageDetail = (data) => request("GET", "/api/storageDetail", data);
export const storageAdd = (data) => request("POST", "/api/storageAdd", data);

export const getGoodsByCode = (data) =>
  request("GET", "/api/getGoodsByCode", data);
export const storageGoodsAdd = (data) =>
  request("POST", "/api/storageGoodsAdd", data);
export const storageGoodsList = (data) =>
  request("GET", "/api/storageGoodsList", data);
