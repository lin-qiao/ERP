  ...
  >
    <el-form ref="formRef" :model="form" label-width="80px" :rules="rules" :inline="false">
      ...
      <el-form-item label="商品名称" prop="name">
        <el-input clearable v-model="name" placeholder="请选择商品名称"></el-input>
      </el-form-item>
      <el-form-item label="商品货号" prop="goodSn">
        <el-input clearable v-model="goodSn" placeholder="请选择商品货号"></el-input>
      </el-form-item>
      <el-form-item label="商品图片" prop="imgUrl">
        <el-input clearable v-model="imgUrl" placeholder="请输入商品图片"></el-input>
      </el-form-item>
      <el-form-item label="图片预览">
        <el-image style="max-height: 52px; max-width: 52px" :src="imgUrl"> </el-image>
      </el-form-item>
      ...
      <el-form-item label="商品尺码" prop="sizeIds">
        <el-checkbox-group v-model="sizeIds" placeholder="请选择商品尺码">
          <el-checkbox v-for="item in sizeList" :key="item.id" :label="item.id" :value="item.id">
            {{ item.size_name }}
          </el-checkbox>
        </el-checkbox-group>
      </el-form-item>
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const { name, goodSn, imgUrl, brandId, sizeIds, purchasePrice } = toRefs(form)
