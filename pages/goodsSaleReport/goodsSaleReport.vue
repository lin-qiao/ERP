				...
				<view class="sale-item" v-for="(item,index) in list" :key="index">
					...
					<view class="goods-info">
						<view class="info-item">
							...
							<view class="profit">毛利：<text :class="item.grossProfitPrice > 0? 'red': 'green'">￥{{item.grossProfitPrice > 0? '+' : ''}}{{formatMoney(item.grossProfitPrice)}}</text></view>
						</view>
						<view class="info-item">
					...
					<view class="detailed">
						<view class="detailed-item">
							...
							<text>总价：￥{{formatMoney(item.businessPriceToTal)}}</text>
						</view>
						<view class="detailed-item">
