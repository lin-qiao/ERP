...
const findAll = async function (
  ...
  return purchaseModel.findAll({
    ...
    attributes: [
      ...
      [
        Sequelize.fn("SUM", Sequelize.col("purchaseGoods.quantity")),
        "totalNumber",
      ],
      [
        Sequelize.fn("SUM", Sequelize.col("purchaseGoods.amount")),
        "totalPrice",
      ],
    ],
    include: [
...
const create = async function (
  { purchaseSn, supplierName, supplierId, itemType, uid },
  t
) {
