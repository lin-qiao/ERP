...
const create = async function(name, goodSn, imgUrl, brandId, sizeIds, purchasePrice, uid) {
...
const update = async function(id, name, goodSn, imgUrl, brandId, sizeIds, purchasePrice) {
